...
const Header = () => {
  ...
  const name = useSelector((state) => state.userSettings.name);
  // const firstName = useSelector((state) => state.userSettings.profileState.firstName);
  ...
  return (
    ...
    <div>
      ...
      <h1 className="text-2xl font-bold">Howdy <span>{name}</span>!</h1>
    </div>
